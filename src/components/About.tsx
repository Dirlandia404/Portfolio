...
function About() {
  return (
    <section id="sobre" className="about">
      <h2>Sobre mim</h2>
      <p>
        Oi, sou <strong>Dirlândia Oliveira</strong>, uma{" "}
        <strong>Software Engineer</strong> apaixonada por desenvolver soluções
        criativas e escaláveis. Me formei em{" "}
        <strong>Sistemas de Informação</strong> pela Universidade Federal do
        Ceará (UFC) e, ao longo da minha jornada, tive a oportunidade de
        trabalhar em projetos incríveis que me ajudaram a crescer tanto como
        profissional quanto como pessoa.
      </p>
      <p>
      ...
      <p>
        Eu acredito que o aprendizado nunca para, cada projeto é uma
        oportunidade de crescer, aprender e inovar, e é isso que me motiva todos
        os dias. Eu adoro desafios e estou sempre buscando soluções novas e
        criativas para problemas complexos. Se você está procurando alguém com
        experiência em <strong>e-commerce</strong>,{" "}
        <strong>desenvolvimento full stack</strong> e{" "}
        <strong>gestão de equipe</strong>, adoraria conversar mais sobre como
        posso agregar ao seu time ou projeto!
      </p>
    </section>
  );
}
